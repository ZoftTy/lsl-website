...
const workingTogetherData = ref([
  {
    ...
    url: "/cooperation/institutions/article/4",
  },
  {
    ...
    <el-row>
      <el-col class="carousel-wrap">
        ...
        >
          <el-carousel-item
            class="carousel"
            v-for="item in workingTogetherData"
            :key="item"
          >
            ...
            <div class="content">
              ...
              <a href="javascript:;" @click="toDetail(item.id)" class="link">
                MORE
